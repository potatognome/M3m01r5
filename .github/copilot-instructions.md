# Copilot Instructions - M3m01r5

## Purpose
M3m01r5 is a journalling and memoir-archiving application. Keep note capture, storage, export, and presentation logic clearly separated.
...
- Keep journal entry storage and export paths driven by config, not by local user-directory assumptions.
- Preserve deterministic export structure and naming where the app depends on archival order.
- Keep text-processing, categorization, and persistence logic modular and testable.
